    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <div class="nill-pageheadertitle">
                <h4><?php _e( 'Album', 'nill' ); ?> <span class="nill-pageheadertitletwo"><?php _e( 'Information', 'nill' ); ?></span></h4>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid nill-padone nill-backgrey nill-padheight">
    <div class="row">
            ...
            <div class="nill-singletitle">
                ...
                <div class="nill-singledate">
                    <ul>
                        ...
                        <li><i class="fa fa-headphones"></i> <?php _e( 'Label:', 'nill' ); ?> <?php echo esc_html(the_field('nill_singername')); ?></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="nill-postimage">
                <div class="nill-postinner">
                    <span class="nill-postinnerimg">
                        ...
                        <?php the_post_thumbnail( 'nill-thumb' ); ?>
                        <?php else: ?>
                    ...
                    <div id="component" class="component component-small <?php echo esc_html(the_field('nill_picturestyles' , 'option')); ?>">
                        <ul class="itemwrap">
                            ...
                            <?php $images = get_field('nill_albumpicslider'); if( $images ): ?>
                            <?php foreach( $images as $image ): ?>
                            <li><img src="<?php echo esc_url($image['sizes']['nill-thumb']); ?>" alt="" /></li>
                            <?php endforeach; ?>
        ...
        <!-- Nill Code Player -->
        <div class="col-md-6">
            <?php include_once('code-album.php'); ?>
        </div>
...
<?php if (get_field('nill_hidepostdetail') == "true"): ?>
<?php else: ?>
<!-- Nill Post Detail -->
<div class="container-fluid nill-padone nill-padheight">
    <div class="row">
        ...
        <!-- Nill Post Left -->
        <div <?php if (get_field('nill_hideposttags') == "true"): ?>class="col-md-12" <?php else: ?> class="col-md-6" <?php endif ; ?>>
            <div class="nill-postdetailtitle">
                <h4><?php _e( 'Album', 'nill' ); ?> <span class="nill-pageheadertitletwo"><?php _e( 'Detail', 'nill' ); ?></span></h4>
            </div>
        ...
        <?php if (get_field('nill_hideposttags') == "true"): ?>
        <?php else: ?>
        <!-- Nill Post Left -->
        <div class="col-md-6">
            ...
            <div class="nill-postdetailtitle">
                <h4><?php _e( 'Album', 'nill' ); ?> <span class="nill-pageheadertitletwo"><?php _e( 'Reviews', 'nill' ); ?></span></h4>
            </div>
            ...
            <!-- Nill Post Tags -->
            <div class="nill-postdetailtitle">
                <h4><?php _e( 'Album', 'nill' ); ?> <span class="nill-pageheadertitletwo"><?php _e( 'Tags', 'nill' ); ?></span></h4>
            </div>
...
<?php if (get_field('nill_hiderelatedposts') == "true"): ?>
<?php else: ?>
<!-- Nill Related Post -->
    ...
    <div class="row">
        ...
        <div class="col-md-12 text-center">
            <div class="nill-pageheadertitlerel">
                <h4><?php _e( 'Related', 'nill' ); ?> <span class="nill-pageheadertitletworel"><?php _e( 'Albums', 'nill' ); ?></span></h4>
            </div>
        </div>
