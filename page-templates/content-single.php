...
<?php if (get_field('nill_hidesinpostdetail') == "true"): ?>
<?php else: ?>
<!-- Nill Post Detail -->
<div class="container-fluid nill-padone nill-padheight">
    <div class="row">
        ...
        <!-- Nill Post Left -->
        <div <?php if (get_field('nill_hidesinposttags') == "true"): ?>class="col-md-12" <?php else: ?> class="col-md-6" <?php endif ; ?>>
        ...
        <?php if (get_field('nill_hidesinposttags') == "true"): ?>
        <?php else: ?>
        <!-- Nill Post Left -->
        <div class="col-md-6">
            ...
            <div class="nill-postdetailtitle">
                <h4><?php _e( 'Post', 'nill' ); ?> <span class="nill-pageheadertitletwo"><?php _e( 'Reviews', 'nill' ); ?></span></h4>
            </div>
...
<?php if (get_field('nill_hidesinglerel') == "true"): ?>
<?php else: ?>
<!-- Nill Related Post -->
    ...
    <div class="row">
        ...
        <div class="col-md-12 text-center">
            <div class="nill-pageheadertitlerel">
                <h4><?php _e( 'Related', 'nill' ); ?> <span class="nill-pageheadertitletworel"><?php _e( 'Posts', 'nill' ); ?></span></h4>
            </div>
        </div>
