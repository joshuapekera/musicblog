    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <div class="nill-pageheadertitle">
                <h4><?php _e( 'Video', 'nill' ); ?> <span class="nill-pageheadertitletwo"><?php _e( 'Information', 'nill' ); ?></span></h4>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid nill-padone nill-backgrey nill-padheight">
    <div class="row">
        ...
        <!-- Nill Code Player -->
        <div class="col-md-12">
            <?php include_once('code-video.php'); ?>
        </div>
...
<?php if (get_field('nill_hidevidpostdetail') == "true"): ?>
<?php else: ?>
<!-- Nill Post Detail -->
<div class="container-fluid nill-padone nill-padheight">
    <div class="row">
        ...
        <!-- Nill Post Left -->
        <div <?php if (get_field('nill_hidevideposttags') == "true"): ?>class="col-md-12" <?php else: ?> class="col-md-6" <?php endif ; ?>>
            <div class="nill-postdetailtitle">
                <h4><?php _e( 'Video', 'nill' ); ?> <span class="nill-pageheadertitletwo"><?php _e( 'Detail', 'nill' ); ?></span></h4>
            </div>
        ...
        <?php if (get_field('nill_hidevideposttags') == "true"): ?>
        <?php else: ?>
        <!-- Nill Post Left -->
        <div class="col-md-6">
            ...
            <div class="nill-postdetailtitle">
                <h4><?php _e( 'Video', 'nill' ); ?> <span class="nill-pageheadertitletwo"><?php _e( 'Reviews', 'nill' ); ?></span></h4>
            </div>
            ...
            <!-- Nill Post Tags -->
            <div class="nill-postdetailtitle">
                <h4><?php _e( 'Video', 'nill' ); ?> <span class="nill-pageheadertitletwo"><?php _e( 'Tags', 'nill' ); ?></span></h4>
            </div>
...
<?php if (get_field('nill_hidevidrelatedposts') == "true"): ?>
<?php else: ?>
<!-- Nill Related Post -->
    ...
    <div class="row">
        ...
        <div class="col-md-12 text-center">
            <div class="nill-pageheadertitlerel">
                <h4><?php _e( 'Related', 'nill' ); ?> <span class="nill-pageheadertitletworel"><?php _e( 'Videos', 'nill' ); ?></span></h4>
            </div>
        </div>
