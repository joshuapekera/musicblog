    ...
    <div class="row">
        ...
        <div class="col-md-12">  
            <div class="nill-quotepost" style="background-image: url(<?php $src = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), array( 600,450 ), false, '' ); echo $src[0]; ?>);">
                ...
                <h1><a href="<?php echo esc_url(the_field('nill_postlink')); ?>"><?php echo esc_html(the_field('nill_postlink')); ?></a></h1>
    ...
    <div class="row">
        ...
        <div class="col-md-12 text-center">
            <div class="nill-pageheadertitlerel">
                <h4><?php _e( 'Related', 'nill' ); ?> <span class="nill-pageheadertitletworel"><?php _e( 'Links', 'nill' ); ?></span></h4>
            </div>
        </div>
