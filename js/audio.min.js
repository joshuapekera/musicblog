(function (e, t, n) {
    ...
    n[e] = {
        ...
        settings: {
            ...
            createPlayer: {
                markup: '<div class="col-xs-12"> <div class="row"> <div class="scrubber"> <div class="progress"></div> <div class="loaded"></div></div> </div></div>  <div class="col-xs-6"> <div class="play-pause"> <p class="play"><i class="fa fa-play"></i></p> <p class="pause"><i class="fa fa-pause"></i></p> <p class="loading"><i class="fa fa-clock-o"></i></p> <p class="error"><i class="fa fa-info-circle"></i></p></div> </div> <div class="col-xs-6"> <div class="time"> <em class="played">00:00</em> / <strong class="duration">00:00</strong></div> </div>  <div class="clearfix"></div> ',
        ...
        newInstance: function (e, r) {
            ...
            } else i.useFlash && !i.hasFlash && this.settings.flashError.apply(u); if (!i.useFlash || i.useFlash && i.hasFlash) this.attachEvents(u.wrapper, u);
...
$(function () {
    var e = audiojs.createAll({
        trackEnded: function () {
            var e = $("ol li.playing").next();
            if (!e.length) e = $("ol li").first();
    ...
    $("ol li span").first().addClass("playing");
    t.load(first);
    $("ol li span").click(function (e) {
        e.preventDefault();
    ...
    $(document).keydown(function (e) {
        ...
        if (n == 39) {
            var r = $("li.playing").next();
            if (!r.length) r = $("ol li").first();
            r.click()
        } else if (n == 37) {
            var i = $("li.playing").prev();
            if (!i.length) i = $("ol li").last();
            i.click()
        } else if (n == 32) {
            t.playPause()
        }
...
(function (e, t, n) {
    ...
    m = function () {
        ...
        f.prototype.reset = function () {
            ...
            this.pane.show();
            this.isActive = true;
            if (this.pane.outerHeight(true) >= e.scrollHeight && s !== b) {
                this.pane.hide();
                this.isActive = false
            } else if (this.el.clientHeight === e.scrollHeight && s === b) {
                this.slider.hide()
            } else {
                this.slider.show()
...
$(function () {
    ...
    $(".btnt-player-inner").find(".description").load("readme.html", function () {
        $(".nano").nanoScroller()
    })
})